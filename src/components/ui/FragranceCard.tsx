...
export function FragranceCard({ product }: FragranceCardProps) {
  ...
  return (
    ...
    >
      <span
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-0 h-[200px] w-3/5 -translate-x-1/2 bg-[radial-gradient(ellipse_at_center_top,rgba(202,164,90,0.14),rgba(9,8,7,0)_70%)]"
      />
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 translate-y-full bg-[linear-gradient(180deg,rgba(9,8,7,0)_0%,rgba(9,8,7,0.82)_26%,rgba(9,8,7,0.97)_60%)] px-6 pb-8 pt-[30px] text-center transition-transform duration-[600ms] ease-premium group-hover:translate-y-0">
        ...
        <span className="mt-[22px] inline-block rounded-[2px] border border-accent/50 px-[30px] py-[11px] font-sans text-[11.5px] uppercase tracking-eyebrow-sm text-[#e7d6a4] transition-colors duration-[400ms] group-hover:bg-accent/90 group-hover:text-[#0a0908]">
