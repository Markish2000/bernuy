...
/** Header del catálogo: back-link + eyebrow + título + subtítulo italic sobre halo dorado. */
export function CollectionHeader({ eyebrow, title, subtitle, backLabel }: CollectionHeaderProps) {
  return (
    <section className="relative overflow-hidden px-5 pb-[30px] pt-[160px] text-center sm:px-6">
      ...
      />
      <div className="relative mx-auto mb-9 max-w-content text-left">
        <Link
          className="inline-flex items-center gap-[9px] font-mono text-[11px] uppercase tracking-eyebrow-sm text-text-muted transition-colors duration-[350ms] hover:text-accent"
          href="/"
        >
